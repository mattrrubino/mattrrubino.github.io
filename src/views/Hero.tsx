function Hero() {
    return (
        <section id="home" className="min-h-dvh flex flex-col px-6 py-28 sm:py-24">
            ...
            <a
                ...
                className="scroll-cue mx-auto mt-12 flex flex-col items-center gap-2 text-text-muted"
            >
