...
const EXPERIENCES: Array<Experience> = [
  {
    ...
    description: [
      "I develop and ship full-stack features on Epic's claims adjudication platform, which serves roughly 50 insurers, using C#, TypeScript, and M. I own a specific portion of a large effort to add new contract modeling functionality to the platform, collaborating with three other developers.",
